...
namespace uLink
{
	...
	{ 
		// This is the maximum prime smaller than Int32.MaxValue
		...
		public static int ExpandPrime(int oldSize)
		{
			...
			if ((uint)newSize > MaxPrime && MaxPrime > oldSize)
			{
				return MaxPrime;
			}
		...
		where T : IEquatable<T>
	{
		...
		{
			//by WuNan @2016/09/19 21:20:57	此处有一个NullReference的Exception，原因待查，暂时做了容错处理
			//return a.Equals(b);
			return a == null 
				? b == null 
