...
namespace uLink
{
	...
	/// </remarks>
	public sealed class HostData : LocalHostData
	{
		/// <summary>
		...
		/// </summary>
		public new int port { get { return externalPort; } }
		...
		/// </summary>
		public new string ipAddress { get { return externalIP; } }

		/// <summary>
		/// Server IP address
		/// </summary>
		//[Obsolete("HostData.ip is deprecated, please use HostData.ipAddress instead")] // TODO: should we really not mark this as deprecated
		public string[] ip { get { return new[] { externalIP, internalIP }; } }

		/// <summary>
		/// Use HostData.externalEndpoint.ToString() instead
		/// </summary>
		[Obsolete("HostData.guid is deprecated, please use HostData.externalEndpoint.ToString() instead")]
		public string guid { get { return externalEndpoint.ipAddress.ToString(); } }
		...
		{
			return Equals(other as HostData);
		}
